...
const main$1 = require("./main-vnWuQTCm.cjs");
...
(function(module2, exports2) {
  ...
  function nopt2(types2, shorthands, args, slice) {
    ...
    clean(data, types2, exports2.typeDefs);
    data.argv = argv;
...
var process$3 = main$1.commonjsGlobal.process;
...
const __dirname$1 = path.dirname(node_url.fileURLToPath(typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("windows-Cx11E880.cjs", document.baseURI).href));
const getAddon = () => {
  const require$1 = node_module.createRequire(typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("windows-Cx11E880.cjs", document.baseURI).href);
